...
%% Read the instruction blocks for how to execute

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%BEGIN REPORT CONTENT SETUP%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1 average queue depth; 
% 2: busy time; 
% 3: average IOPS/throughput/request size; 
% 4: size distribution 
% 5: LBA vs time; 
% 6: sequential analysis; 
% 7: sequential analysis (queue length)
...
options.report_name='my-report.ppt';

options.plot_fontsize=10;
options.time_interval=50;
options.plot_figure=1;
% some trace is not started from zone. in this case. need to find the starting time of first event.
