function [n_seq_cmd, n_seq_stream, n_read_cmd, n_total_cmd,size_dist,seq_stream_length_count,seq_stream_length_count_limited,ex_record]=sequential_stream_track(q_len, traces, access_type,seq_size_threshold)
